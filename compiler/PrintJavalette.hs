...
instance Print AbsJavalette.Item where
  prt i e = case e of
    AbsJavalette.NoInit id -> prPrec i 0 (concatD [prt 0 id])
...
instance Print AbsJavalette.Type where
  prt i e = case e of
    ...
    AbsJavalette.String -> prPrec i 0 (concatD [doc (showString "string")])
...
instance Print AbsJavalette.Exp where
  prt i e = case e of
    AbsJavalette.ETyped exp type_ -> prPrec i 0 (concatD [doc (showString "["), prt 0 exp, doc (showString ":"), prt 0 type_, doc (showString "]")])
